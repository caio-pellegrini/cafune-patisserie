                    ...
                    <div class="md:col-span-2 space-y-6">
                            ...
                            <section>
                                ...
                                <div class="mt-4">
                                    ...
                                    @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && !$user->hasVerifiedEmail())
                                        <div>
                                            <div class="bg-red-100 border border-red-400 text-red-800 px-3 py-2 text-sm rounded relative "
                                                role="alert">
                                                ...
                                                <span
                                                    class="block sm:inline">{{ __(' para prosseguir com o pedido.') }}</span>

                                            </div>
                                        </div>
                                    @endif
                                    <p><strong>{{ __('Phone') }}:</strong> {{ $user->phone ?? 'Não definido' }}</p>
                                    <p><strong>{{ __('Address') }}:</strong> {{ $user->address ?? 'Não definido' }}
                                    </p>
                                </div>
                        ...
                        <div class="p-8 bg-white shadow rounded-lg">
                            ...
                            <div id="card_info" class="hidden">
                                ...
                                <input type="number" name="installments" placeholder="Número de Parcelas"
                                    class="mb-2">
                            </div>
                    ...
                    <div class="md:col-span-1 space-y-6">
                        <div class="p-8 bg-white shadow rounded-lg">
                            ...
                            <button id="finalizar-pedido"
                                @if (auth()->check() && auth()->user()->hasVerifiedEmail()) type="submit"
                            @else
                                type="button" @endif
