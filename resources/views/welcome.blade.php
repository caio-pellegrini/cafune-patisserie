    ...
    <div class="container">
        ...
        <div class="flex justify-center items-center flex-wrap mt-[50px]">
            ...
            <div class="relative">
                ...
                <a href="#" class="absolute left-2/4 top-[650px] transform -translate-x-1/2 -translate-y-1/2 bg-[#2C2B4C] text-[white] px-[20px] py-[15px] no-underline inline-block text-[15px] cursor-pointer border-[none] rounded-[20px] hover:bg-cafune">CONHEÇA O CARDÁPIO</a>
            </div>
        </div>

        <div class="relative w-full">
            <img class="w-full block" src="{{asset('/home/Banner 2.png')}}" alt="">
            <a href="#" class="absolute left-2/4 top-[450px] transform -translate-x-1/2 -translate-y-1/2 bg-[#2C2B4C] text-[white] px-[40px] py-[15px] no-underline inline-block text-[15px] cursor-pointer border-[none] rounded-[20px] hover:bg-cafune">SOBRE NÓS</a>
        </div>
        ...
        <div class="flex items-center justify-center mt-[50px] p-[20px]">
            ...
            <div>
                ...
                <a class="bg-[#2C2B4C] text-[white] px-[20px] py-[15px] no-underline inline-block text-[15px] cursor-pointer border-[none] rounded-[20px] hover:bg-cafune" href="#">JUNTE-SE A NÓS!</a>
            </div>
        </div>
